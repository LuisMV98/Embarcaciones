...
<head>
    ...
    <title>Selecciona || Empleado</title>
        ...
        <div class="col s12 l4 offset-l4 m10 offset-m1">
            <div class="card z-depth-4">
                <div class="card-action black white-text">
                    <h5><i class="material-icons left">work</i>Seleccione la empresa</h5>
                </div><br>
                <div class="card-content">
                    <form action="ver_empleados.php" method="post">    <!-- Formulario -->
                        <div class="form-field">
                            ...
                            <?php
                                ...
                                $link = Conectar();
                                $query   = ("SELECT * FROM empresas WHERE empleados<>0 ORDER BY nombre");
                        ...
                        <button type="submit" class="btn green darken-1 waves-effect waves-dark" style="float: right;">Aceptar</button>
                    </form>
