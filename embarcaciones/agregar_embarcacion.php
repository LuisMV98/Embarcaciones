...
<head>
    ...
    <title>Agrega || Embarcación</title>
...
<body>
        ...
        <div class="col s12 l4 offset-l4 m10 offset-m1">
            <div class="card z-depth-4">
                <div class="card-action black white-text">
                    <h5><i class="material-icons left">directions_boat</i>Nueva Embarcación</h5>
                </div>
                <div class="card-content">
                    <form action="registrar_embarcacion.php" method="post" enctype="multipart/form-data">    <!-- Formulario -->
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="tip" id="tipo" class="validate" required>
                        </div><br>
                        <div class="form-field">
                            <label for="salida">Fecha de salida</label>
                            <input type="date" name="sali" id="salida" class="validate" min="<?php echo date('Y-m-d');?>" required>
                        </div><br>
                        <div class="form-field">
                            <label for="entrega">Fecha de entrega</label>
                            <input type="date" name="entre" id="entrega" class="validate" min="<?php echo date('Y-m-d');?>" required>
                        </div><br><br>
    ...
    <div id="agregado" class="modal">
        <div class="modal-content green lighten-4">
            <h4><i class="material-icons medium left green-text text-darken-2">check_circle</i>Nueva embarcación agregada.</h4>
        </div>
